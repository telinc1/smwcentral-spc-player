...
```html
<link rel="stylesheet" href="https://unpkg.com/@smwcentral/spc-player@1.0.0/dist/spc_player.css">
<script src="https://unpkg.com/@smwcentral/spc-player@1.0.0/dist/spc.js"></script>
```
