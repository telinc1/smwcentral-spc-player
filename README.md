...
```html
<link rel="stylesheet" href="https://unpkg.com/@smwcentral/spc-player@1.3.1/dist/spc_player.css">
<script src="https://unpkg.com/@smwcentral/spc-player@1.3.1/dist/spc.js"></script>
```
